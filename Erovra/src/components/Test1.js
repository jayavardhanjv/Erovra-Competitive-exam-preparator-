...
import { getDatabase, push, query, ref, set, update } from "firebase/database";
...
// const update=()=>{
up =(L2+n);
// updateDoc(doc(db, "report",UserData), {
//   "score":{ 
//   "bro":2
//   }});
...
< button onClick={()=>{Push();handle();update()}} class="items-center bg-center  relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
