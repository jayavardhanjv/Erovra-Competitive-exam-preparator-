...
export default function Test(){
  ...
  const {questions } = useQuestions(ida);
...
// }
    return (
      <div className="py-12 max-h-fit bg-green-500 shadow-md rounded-xl">
  ...
  <select value={ida} onChange={handleChange} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input" required>
  <option value=""></option>  
  ...
  <select value={Level} onChange={handlChange} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input" required>
  <option value=""></option>  
  ...
  {/* </div> */}
  {/* <div class="absolute inset-y-14 right-1 flex items-center px-2 pointer-events-none">
    <svg class="w-6 h-6 fill-current" viewBox="0 0 10 20"><path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" fill-rule="evenodd"></path></svg>
  </div> */}
</div>
<form class="space-y-4 text-gray-700">
  <div class="flex flex-wrap">
    <div class="w-full">
      ...
      <input type="text" placeholder="Enter the question" value={que} 
          onChange={(e) => setQue(e.target.value)} class=" block p-4 w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline"  id="formGridCode_card" required/>
    </div>
  </div>
  <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
    <div class="w-full px-2 md:w-1/2">
      <label class="block mb-1" for="formGridCode_name">option A</label>
      <input required placeholder="enter the option" value={a} 
    ...
    <div class="w-full px-2 md:w-1/2">
      ...
      <input required placeholder="enter the option" value={b} 
  ...
  <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
    <div class="w-full px-2 md:w-1/2">
      ...
      <input required placeholder="enter the option" value={c} 
    ...
    <div class="w-full px-2 md:w-1/2">
      ...
      <input required placeholder="enter the option" value={d} 
    ...
    <br/><br/>
    <br/><br/>
    <h1 class="justify-center text-center text-xl">Enter the correct option</h1>
  </div>
  
  <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
    <div class="w-full px-2 md:w-1/4">
    <label class="block mb-1" for="formGridCode_cvc">Select option A</label>
  <select required value={a1} onChange={handleaChange} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
  <option value=""></option>  
  ...
  <select required value={b1} onChange={handlebChange} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
  <option value=""></option> <option value=" ">false</option>  
  <option value="true">true</option>
  </select>
    </div>
    <div class="w-full px-2 md:w-1/4">
    <label class="block mb-1" for="formGridCode_cvc">Select option A</label>
  <select required value={c1} onChange={handlecChange} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
  <option value=""></option>  <option value=" ">false</option>  
  <option value="true">true</option>
  </select>
    </div>
    <div class="w-full px-2 md:w-1/4">
    <label class="block mb-1" for="formGridCode_cvc">Select option A</label>
  <select required value={d1} onChange={handledChange} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
  <option value=""></option> <option value=" ">false</option>  
  <option value="true">true</option>
  </select>
    </div>
...
< button onClick={()=>{levelup();Push(ida,Level,que,a,b,c,d,a1,b1,c1,d1);handle()}} class="items-center bg-center  relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-red-600 transition duration-300 ease-out border-2 border-red-500 rounded-full shadow-md group">
...
<span class="absolute bold flex items-center justify-center w-full h-full text-red-500 transition-all duration-300 transform group-hover:translate-x-full ease">Submit</span>
